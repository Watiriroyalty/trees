<?php
//creating a route group to prefix all the admin routes with /admin
Route::group(['prefix'  =>  'admin'], function () {
    //this loads the admin login page
    Route::get('login', 'Admin\LoginController@showLoginForm')->name('admin.login');
    //to send the post request for Authentication
    Route::post('login', 'Admin\LoginController@login')->name('admin.login.post');
      //the logout route.
    Route::get('logout', 'Admin\LoginController@logout')->name('admin.logout');
/*passing the middleware auth admin and putting the admin.dashboard route into a group so that all the admin routes will be protected
using the guard**/
